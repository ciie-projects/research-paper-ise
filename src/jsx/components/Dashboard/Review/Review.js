...
// 									<h3 className="fs-20 text-black font-w600 mb-2"><Link to={"/app-profile"} className="text-black">{isAuthenticated && info[0].username}</Link></h3>
...
// 									<h2 className="text-black font-w600">{isAuthenticated && info[0].experience}</h2>
