...
//                     <h4 className="text-primary mb-0">{user && info.username}</h4>
//                     <p>{user && info.desgination}</p>
//                   </div>
//                   <div className="profile-email px-2 pt-2">
//                     <h4 className="text-muted mb-0">{user && info.email}</h4>
//                     <p>Email</p>
//                   </div>
...
// 									<i className="flag-icon flag-icon-us" />{user && info.researchInt}
// 								</Link>
// 								{/* <Link to="/app-profile" className="text-muted pr-3 f-s-16">
...
// 									</div>
// 									<div className="col-9">
// 										<span>{user && info.experience} Year Experiences</span>
// 									</div>
// 								</div>
// 							</div>
// 						</div>
...
const AppProfile = () => {
  ...
  return (
    <Fragment>
      ...
      <br></br>
      <br></br>
      <h4 className="text-primary">Update Profile Pic</h4>
      <input
        className="form-control"
        type="file"
        onChange={saveFile}
