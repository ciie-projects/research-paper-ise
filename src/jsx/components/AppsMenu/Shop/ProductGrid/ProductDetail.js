...
const ProductDetail = () => {
  ...
  return (
    <>
      <PageTitle motherMenu="Profile" activeMenu={user && info.username} />
      <div className="row">
                    ...
                    <div className="new-arrival-content pr">
                      ...
                      <div className="comment-review star-rating">
                        ...
                        <span className="review-text">
                          ({info.experience} years of experience){" "}
                        </span>
                      </div>
                      ...
                      <p>
                        Email id:{" "}
                        <span className="item"> {user && info.email} </span>
                      </p>
                      <p>
                        Designation: <span className="item"></span>
                        {user && info.desgination}
                      </p>
                      <p>
                        Research Interests:&nbsp;&nbsp;
                      ...
                      <p className="text-content">{user && info.aboutme}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Table responsive hover className="header-border verticle-middle">
              ...
              <tbody>
                {sub?.map((member, key) => (
                  <tr>
                    <td>
                      <a href={user && member}>{user && member}</a>
                    </td>
                  </tr>
                ))}
              </tbody>
